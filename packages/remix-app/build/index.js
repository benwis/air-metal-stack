...
function flattenRoutes(routes2, branches, parentsMeta, parentPath) {
  ...
  routes2.forEach((route, index) => {
    ...
    if (route.children && route.children.length > 0) {
      !(route.index !== true) ? true ? invariant(false, "Index routes must not have child routes. Please remove " + ('all child routes from route path "' + path2 + '".')) : invariant(false) : void 0;
...
function compilePath(path2, caseSensitive, end) {
  ...
  true ? warning(path2 === "*" || !path2.endsWith("*") || path2.endsWith("/*"), 'Route path "' + path2 + '" will be treated as if it were ' + ('"' + path2.replace(/\*$/, "/*") + '" because the `*` character must ') + "always follow a `/` in the pattern. To get rid of this warning, " + ('please change the route path to "' + path2.replace(/\*$/, "/*") + '".')) : void 0;
  let paramNames = [];
...
function useNavigate() {
  ...
  let navigate = (0, import_react.useCallback)(function(to, options) {
    ...
    (!!options.replace ? navigator.replace : navigator.push)(path2, options.state);
...
function createRequestHandler2({
  ...
  const remixHandler2 = createRequestHandler(build, mode);
  return async (request) => {
    try {
      const loadContext = getLoadContext ? await getLoadContext(request) : void 0;
...
async function serveStaticFiles(request, {
  ...
  const contentType = import_mime.default.getType(url.pathname);
  if (contentType) {
...
function createRequestHandlerWithStaticFiles({
  ...
  const remixHandler2 = createRequestHandler2({ build, mode, getLoadContext });
  return async (request) => {
    try {
...
function getNewMatchesForLinks(page, nextMatches, currentMatches, location, mode) {
  ...
  let newMatches = mode === "data" && location.search !== path2.search ? nextMatches.filter((match, index) => {
...
var NavLink2 = /* @__PURE__ */ React2.forwardRef((_a, forwardedRef) => {
  var _b = _a, {
    to,
    prefetch = "none"
...
var Link2 = /* @__PURE__ */ React2.forwardRef((_a, forwardedRef) => {
  var _b = _a, {
    to,
    prefetch = "none"
  } = _b, props = __objRest(_b, [
...
function Links() {
  ...
  return /* @__PURE__ */ React2.createElement(React2.Fragment, null, links.map((link) => isPageLinkDescriptor(link) ? /* @__PURE__ */ React2.createElement(PrefetchPageLinks, _extends3({
    key: link.page
...
function PrefetchPageLinks(_a) {
  ...
  return /* @__PURE__ */ React2.createElement(PrefetchPageLinksImpl, _extends3({
    page,
    matches
  }, dataLinkProps));
}
...
function Meta() {
  ...
  return /* @__PURE__ */ React2.createElement(React2.Fragment, null, Object.entries(meta2).map(([name, value]) => {
    ...
    return [value].flat().map((content) => {
      ...
      return /* @__PURE__ */ React2.createElement("meta", _extends3({
...
window.__remixRouteModules = {${matches.map((match, index) => `${JSON.stringify(match.route.id)}:route${index}`).join(",")}};`;
  ...
  return /* @__PURE__ */ React2.createElement(React2.Fragment, null, dedupe2(preloads).map((path2) => /* @__PURE__ */ React2.createElement("link", {
    key: path2,
    rel: "modulepreload",
    href: path2,
...
var FormImpl = /* @__PURE__ */ React2.forwardRef((_a, forwardedRef) => {
  var _b = _a, {
...
function useFormAction(action = ".", method = "get") {
  ...
  let path2 = useResolvedPath(action);
  let search = path2.search;
  let isIndexRoute = id.endsWith("/index");
  if (action === "." && isIndexRoute) {
    search = search ? search.replace(/^\?/, "?index&") : "?index";
  }
  return path2.pathname + search;
}
    ...
    dangerouslySetInnerHTML: {
      __html: js`
                (() => {
                  ...
                  let socketPath = protocol + "//" + host + ":" + ${String(port2)} + "/socket";
...
function handleRequest(request, responseStatusCode, responseHeaders, remixContext) {
  const markup = (0, import_server4.renderToString)(/* @__PURE__ */ React5.createElement(RemixServer, {
...
// route:/Users/benwis/Documents/remix-air-metal/packages/remix-app/app/root.tsx
var root_exports = {};
...
function App() {
  return /* @__PURE__ */ React6.createElement("html", {
    lang: "en"
  }, /* @__PURE__ */ React6.createElement("head", null, /* @__PURE__ */ React6.createElement(Meta, null), /* @__PURE__ */ React6.createElement(Links, null)), /* @__PURE__ */ React6.createElement("body", null, /* @__PURE__ */ React6.createElement(Outlet, null), /* @__PURE__ */ React6.createElement(ScrollRestoration, null), /* @__PURE__ */ React6.createElement(Scripts, null), /* @__PURE__ */ React6.createElement(LiveReload, null)));
}

// route:/Users/benwis/Documents/remix-air-metal/packages/remix-app/app/routes/index.tsx
var routes_exports = {};
...
function Index() {
  ...
  }, /* @__PURE__ */ React7.createElement("h1", null, "Welcome to Remix"), /* @__PURE__ */ React7.createElement("ul", null, /* @__PURE__ */ React7.createElement("li", null, /* @__PURE__ */ React7.createElement("a", {
    target: "_blank",
    href: "https://remix.run/tutorials/blog",
    rel: "noreferrer"
  }, "15m Quickstart Blog Tutorial")), /* @__PURE__ */ React7.createElement("li", null, /* @__PURE__ */ React7.createElement("a", {
    target: "_blank",
    href: "https://remix.run/tutorials/jokes",
    rel: "noreferrer"
  }, "Deep Dive Jokes App Tutorial")), /* @__PURE__ */ React7.createElement("li", null, /* @__PURE__ */ React7.createElement("a", {
    target: "_blank",
...
var assets_manifest_default = { "version": "abb02a57", "entry": { "module": "/build/entry.client-QBGAVMZD.js", "imports": ["/build/_shared/chunk-BOALOUT7.js", "/build/_shared/chunk-IXQ7VTEE.js"] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "module": "/build/root-B54GOAG7.js", "imports": void 0, "hasAction": false, "hasLoader": false, "hasCatchBoundary": false, "hasErrorBoundary": false }, "routes/index": { "id": "routes/index", "parentId": "root", "path": void 0, "index": true, "caseSensitive": void 0, "module": "/build/routes/index-6ARTOD5T.js", "imports": void 0, "hasAction": false, "hasLoader": false, "hasCatchBoundary": false, "hasErrorBoundary": false } }, "url": "/build/manifest-ABB02A57.js" };
